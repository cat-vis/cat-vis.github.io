const userDefinedTagCategories = {
	...
	"data_type": {
		"description": "the type of data for which the technique is designed"
	},
	"dimensionality": {
		"description": "the number of categorical variables, or dimensions, that the technique supports (extensions may be possible)"
	},
	"cardinality": {
