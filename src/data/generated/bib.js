const generatedBibEntries = {
    "FilippovaShneiderman2009": {
        ...
        "type": "techreport Technical Report",
    ...
    "alsallakh2011contingency": {
        ...
        "keywords": "contribution:technique, alignment:radial, data_type:homogeneous, dimensionality:trivariate, cardinality:very_high, family:other",
        "pages": "53-56",
    ...
    "beh2014correspondence": {
        ...
        "keywords": "contribution:textbook, family:projection, data_type:heterogeneous, projection_transformation, projection_representation",
    ...
    "friendly2003effect": {
        "abstract": "ABSTRACT: This paper outlines a general framework for ordering information in visual displays (tables and graphs) according to the effects or trends which we desire to see. This idea, termed effect-ordered data displays, applies principally to the arrangement of unordered factors for quantitative data and frequency data, and to the arrangement of variables and observations in multivariate displays (star plots, parallel coordinate plots, and so forth). As examples of this principle, we present several techniques for ordering items, levels or variables \u201coptimally\u201d, based on some desired criterion. All of these may be based on eigenvalue or singular-value decompositions. Along the way, we tell some stories about data display, illustrated by graphs\u2014some surprisingly bad, and some surprisingly good\u2014for showing patterns, trends, and anomalies in data. We hope to raise more questions than we can provide answers for.",
    ...
    "thane2023catnetvis": {
        ...
        "keywords": "contribution:technique, family:other, data_type:heterogeneous, dimensionality:multivariate, cardinality:high, network, alignment:other",
